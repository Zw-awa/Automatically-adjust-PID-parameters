 ...
 * UART/中断在 PidTunerPort.c，传感器/PWM 在 PidTunerUser.c。
 * 一般移植时不需要修改本文件。
 */
typedef struct
{
...
static void parse_command(const char *line)
{
    ...
    /* 协议 v2 使用 request_id，避免旧 ACK 被误认为本次响应。 */
    if (sscanf(
            line,
